...
describe("home welcome translations", () => {
  ...
  it.each([
    ["en", en, "welcome to memos", "Capture your thoughts and everyday inspiration."],
    ["zh-Hans", zhHans, "welcome to memos", "记录此刻的想法，留住日常的灵感。"],
    ["zh-Hant", zhHant, "welcome to memos", "記錄此刻的想法，留住日常的靈感。"],
  ...
  it.each(["az", "fr"])("falls back to English for missing welcome copy in %s", async (locale) => {
    ...
    expect(i18n.t("home.welcome-title")).toBe("welcome to memos");
