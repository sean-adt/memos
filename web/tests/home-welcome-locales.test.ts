...
describe("home welcome translations", () => {
  ...
  it.each([
    ["en", en, "123456789", "Capture your thoughts and everyday inspiration."],
    ["zh-Hans", zhHans, "123456789", "记录此刻的想法，留住日常的灵感。"],
    ["zh-Hant", zhHant, "123456789", "記錄此刻的想法，留住日常的靈感。"],
  ...
  it.each(["az", "fr"])("falls back to English for missing welcome copy in %s", async (locale) => {
    ...
    expect(i18n.t("home.welcome-title")).toBe("123456789");
